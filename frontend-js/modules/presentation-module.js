...
export default function PresentationModule() {
    ...
    function renderSingleProduct() {
        ...
        const featuresContent = selectedProduct.features.map(feature => `
            <div class="feature">
                <h3>${feature.name}</h3>
        ...
        const specificationsContent = Object.entries(selectedProduct.specifications).map(([category, specs]) => `
            <div class="specifications-category">
                <h2>${category}</h2>
                <ul>
